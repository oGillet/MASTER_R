...
`r emo::ji("warning")` Votre rendu doit faire quatre pages maximum et est à déposer au plus tard le  `r emo::ji("date")` 31 décembre 2021 sur [Universitice](https://universitice.univ-rouen.fr)  
